use {
    ...
    initium_posync::posync_recorder::PosyncRecorder,
    initium_runtime::bank_forks::BankForks,
    initium_sdk::{clock::Slot, transaction::Transaction},
    std::{
...
impl VotingService {
    ...
    pub fn handle_vote(
        ...
        let target_address = if send_to_tpu_vote_port {
            crate::banking_stage::next_prime_tpu_vote(cluster_info, posync_recorder)
        } else {
            crate::banking_stage::next_prime_tpu(cluster_info, posync_recorder)
        };
