use {
    ...
    bincode::deserialize,
    serde_json::Value,
    initium_config_program::{get_config_data, ConfigKeys},
     initium_sdk::{
        pubkey::Pubkey,
...
mod test {
    use {
        super::*, crate::validator_info::ValidatorInfo, serde_json::json,
         initium_config_program::create_config_account,  initium_sdk::account::ReadableAccount,
    };
    ...
    fn test_parse_config() {
        ...
        let info_pubkey =  initium_sdk::pubkey::new_rand();
        ...
        assert_eq!(
            ...
            ConfigAccountType::ValidatorInfo(UiConfig {
                ...
                config_data: serde_json::from_str(r#"{"name":"Initium"}"#).unwrap(),
            }),
        );
